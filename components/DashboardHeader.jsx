...
const DashboardHeader = () => {
  return (
    <header className="fixed top-0 right-0 left-20 lg:left-24 bg-white/80 backdrop-blur-md border-b border-slate-100 h-20 px-8 flex items-center justify-between z-40">
