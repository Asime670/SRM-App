...
const ResultForm = ({ onSubmit }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="premium-card !p-10 border border-border">
        <div className="flex items-center gap-4 mb-10 pb-6 border-b border-border">
          ...
          <div>
            <h2 className="text-2xl font-bold title-serif text-foreground">Add New Result</h2>
            <p className="text-muted text-sm font-medium">Capture student academic performance</p>
          </div>
        </div>
        
        {error && (
          <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/20 text-red-600 text-sm rounded-xl border border-red-100 dark:border-red-900/30 flex items-center gap-2 animate-in fade-in zoom-in duration-300">
        ...
        <div className="space-y-8">
          ...
          <div className="group">
            <label className="block text-sm font-bold text-foreground mb-2 group-focus-within:text-primary transition-colors">Subject</label>
            <div className="relative">
              <select
                name="subject"
          ...
          <div className="group">
            <label className="block text-sm font-bold text-foreground mb-2 group-focus-within:text-primary transition-colors">Score (0-100)</label>
            <div className="relative">
              <input
                type="number"
                name="score"
