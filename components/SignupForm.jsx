...
const SignupForm = () => {
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom duration-700">
      <div className="mb-10">
        <h2 className="text-4xl font-bold title-serif text-slate-900 dark:text-white mb-3">Create Account</h2>
        <p className="text-slate-500 dark:text-slate-400 font-medium">Start managing results effectively today</p>
      </div>
